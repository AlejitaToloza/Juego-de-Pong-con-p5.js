...
let computadoraX = anchoCanvas - 45;
let computadoraY;
...
function preload() {
    ...
    sonidoGol = loadSound('banana.mp3');
}
...
function mostrarPuntaje() {
    ...
    fill(color("#FFFFFF"));
    text(`Jugador: ${jugadorScore}`, width / 4, grosorMarco * 3);
    text(`Computadora: ${computadoraScore}`, 3 * width / 4, grosorMarco * 3);
}
...
function verificarColisiones() {
    ...
    if (pelotaX - diametroPelota / 2 < jugadorX + anchoRaqueta && 
        ...
        // Ajustar la posición de la pelota para evitar que quede atrapada
        pelotaX = jugadorX + anchoRaqueta + diametroPelota / 2; // Mueve la pelota fuera de la raqueta
    ...
    if (pelotaX + diametroPelota / 2 > computadoraX && 
        ...
        // Ajustar la posición de la pelota para evitar que quede atrapada
        pelotaX = computadoraX - diametroPelota / 2; // Mueve la pelota fuera de la raqueta
        sonidoRebote.play(); // Reproducir sonido de rebote
    }
